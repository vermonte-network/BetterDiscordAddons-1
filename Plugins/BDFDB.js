(_ => {
	...
	BDFDB.DOMUtils.appendLocalStyle("BDFDB", `
		...
		${BDFDB.dotCNS.popout + BDFDB.dotCN.searchbarwrapper} {
			padding: 0 0 5px 0;
		...
		${BDFDB.dotCNS.paginationlistmini + BDFDB.dotCN.paginationlistpagination} {
			font-size: 14px;
			line-height: 18px;
			margin-top: 5px;
			margin-bottom: 5px;
		}
		${BDFDB.dotCNS.paginationlistmini + BDFDB.dotCN.paginationlistalphabet} {
			font-size: 14px;
			line-height: 18px;
			margin-bottom: 5px;
		}
		${BDFDB.dotCNS.paginationlistmini + BDFDB.dotCN.paginationlistalphabetchar} {
			min-width: 10px;
			margin: 0 3px;
		}
		${BDFDB.dotCNS.paginationlistmini + BDFDB.dotCN.searchresultspaginationbutton} {
			height: 16px;
			width: 16px;
			margin: 0 6px;
		}
		${BDFDB.dotCNS.paginationlistmini + BDFDB.dotCN.searchresultspaginationicon} {
			height: 12px;
			width: 12px;
		}
		...
		.platform-osx ${BDFDB.dotCN.noticewrapper} ~ * ${BDFDB.dotCN.guildswrapper} {
			margin-top: 0;
		}
		.platform-osx ${BDFDB.dotCN.noticewrapper} ~ * ${BDFDB.dotCN.guildsscroller} {
			padding-top: 4px;
		}
