//META{"name":"RolesTag","authorId":"596773775404564481","invite":"Jx3TjNS"}*//
...
var RolesTag = (_ => {
	...
	return class RolesTag {
		getName () {return "RolesTag";}
			...
			if (settings.useCrown) {
				...
				switch (userType) {
					...
					case userTypes.ADMIN:
						...
						label = [BDFDB.UserUtils.can("Administrator", user.id) && BDFDB.LanguageUtils.LanguageStrings.ADMINISTRATOR].filter(n => n).join(", ");
						break;
					case userTypes.MANAGEMENT:
